...
FrameworkReturnCode SolARPointCloudExporterHapPLY::exportPointCloud(const std::string & filepath, const SRef<const SolAR::datastructure::PointCloud> & pointCloud)
{
    try
    {
